package android.practices.sqlitesample.DataBase;
...
public class NotePadDB extends SQLiteOpenHelper {
    ...
    public static final String dbname = "Notepad.db";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(
                "create table mynotes" + "(_id integer primary key, name text,remark text,dates text)");
    }
    ...
    public Cursor getNotesData(int id) {
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor z = db.rawQuery(
                "select * from " + mynotes + " where _id=" + id + "", null);
        return z;
    }

    public int countRowNumbers() {
        SQLiteDatabase db = this.getReadableDatabase();
    ...
    public Cursor fetchAllNotes() {
        ...
        Cursor mCursor = db.query(
                mynotes, new String[]{"_id", "name", "dates", "remark"},
